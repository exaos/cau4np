...
#+INCLUDE: "./sample-spec-multi-chn.yaml" src yaml
...
| ~float32~    |   4 | Single precision float: sign bit, 8 bits exponent, 23 bits mantissa  |
| ~float64~    |   8 | Double precision float: sign bit, 11 bits exponent, 52 bits mantissa |
